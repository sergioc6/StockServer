...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table id="example" class="display" cellspacing="0" width="100%">
            ...
            <tbody>
                <tr>
                    <td>Taladro Black & Decker 8000 900w</td>
                    <td>Taladros</td>
                    <td>Pasillo 4, estante 4B</td>
                    <td>20</td>
                </tr>
                <tr>
                    <td>Cubiertas Pirelli Clase C</td>
                    <td>Cubiertas</td>
                    <td>Sector 2A</td>
                    <td>50</td>
                </tr>
                <tr>
                    <td>Lubricante en seco W40</td>
                    <td>Lubricantes/Prod. químicos</td>
                    <td>Pasillo 2, estante 5C</td>
                    <td>60</td>
                </tr>
            </tbody>
        </table>
